...
const (
	...
	TriggerType_TRANSACTION_SIMPLE TriggerType_Value = "TRANSACTION_SIMPLE"
...
func TriggerType_Values() []TriggerType_Value {
	return []TriggerType_Value{TriggerType_PERIODIC, TriggerType_WEBHOOK, TriggerType_TRANSACTION, TriggerType_BLOCK, TriggerType_ALERT, TriggerType_TRANSACTION_SIMPLE}
}
...
func (e TriggerType) IsUnknown() bool {
	switch e.val {
	case TriggerType_PERIODIC, TriggerType_WEBHOOK, TriggerType_TRANSACTION, TriggerType_BLOCK, TriggerType_ALERT, TriggerType_TRANSACTION_SIMPLE:
		return false
	}
	return true
}
...
func (e *TriggerType) UnmarshalText(data []byte) error {
	...
	case "TRANSACTION_SIMPLE":
		*e = New_TriggerType(TriggerType_TRANSACTION_SIMPLE)
	}
	return nil
}
